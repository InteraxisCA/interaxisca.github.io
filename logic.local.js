...
var linkTemplate = './videos/$video#t=$time';  
var totalLimit = 250;
...
var controls = {
    ...
    updateResults: function(loc, results) {
        if (results.length == 0) {
            ...
            noResults.style.display = '';
            resultsTableHideable.classList.add('hide');
            noResults.textContent = 'Error: ' + results.length + ' resultados encontrados, intente ser mas preciso en su criterio de busqueda';
